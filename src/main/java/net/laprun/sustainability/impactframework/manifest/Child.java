...
public class Child {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof Child child))
      return false;
    return Objects.equals(pipeline, child.pipeline) && Objects.equals(defaults, child.defaults)
        && Objects.equals(inputs, child.inputs) && Objects.equals(children, child.children);
  }
